...
public class RoleController {
    ...
    public ResponseResult findResourceListByRoleId(Integer roleId) {
        ...
        //根据角色id查询资源分类和资源信息 调用接口
        List<ResourceCategory> resourceCategoryByRoleId = roleService.findResourceListByRoleId(roleId);

        ResponseResult responseResult = new ResponseResult(true, 200, "获取当前角色拥有的资源信息成功",resourceCategoryByRoleId);
    ...
    public ResponseResult roleContextResource(@RequestBody RoleResourceVo roleResourceVo) {
        ...
        ResponseResult responseResult = new ResponseResult(true, 200, "获取当前角色拥有的资源信息成功",null);
